...
public class ModRegistries {
	...
	public static void registerBrews(RegistryEvent.Register<Brew> event) {
		...
		event.getRegistry().register(new Brew(new ResourceLocation(Bewitchment.MODID, "sinking"), Util.get("oreGoldSmall", "oreWroughtIronSmall", "nuggetColdIron", "nuggetCopper", "nuggetTin", "nuggetBronze", "nuggetLead"), new PotionEffect(ModPotions.sinking, (20 * 20))));
