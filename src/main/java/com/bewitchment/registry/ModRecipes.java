...
public class ModRecipes {
	...
	private static void altarInit() {
		...
		Util.registerAltarUpgradeOreDict("gemGarnet", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 1, 0));
		...
		Util.registerAltarUpgradeOreDict("gemBeryl", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 1, 0));
		...
		Util.registerAltarUpgradeOreDict("gemChippedAgate", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 1, 0));
		...
		Util.registerAltarUpgradeOreDict("gemChippedBeryl", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 1, 0));
		...
		Util.registerAltarUpgradeOreDict("gemChippedGarnet", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 1, 0));
		...
		Util.registerAltarUpgradeOreDict("gemChippedJade", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 1, 0));
		...
		Util.registerAltarUpgradeOreDict("gemChippedTourmaline", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 1, 0));
		...
		Util.registerAltarUpgradeOreDict("gemFlawedAgate", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 1, 0));
		Util.registerAltarUpgradeOreDict("gemFlawedAmethyst", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 1, 0));
		Util.registerAltarUpgradeOreDict("gemFlawedBeryl", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 1, 0));
		Util.registerAltarUpgradeOreDict("gemFlawedDiamond", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 1, 0));
		Util.registerAltarUpgradeOreDict("gemFlawedEmerald", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 1, 0));
		Util.registerAltarUpgradeOreDict("gemFlawedGarnet", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 1, 0));
		Util.registerAltarUpgradeOreDict("gemFlawedJade", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 1, 0));
		Util.registerAltarUpgradeOreDict("gemFlawedJasper", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 1, 0));
		Util.registerAltarUpgradeOreDict("gemFlawedOpal", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 1, 0));
		Util.registerAltarUpgradeOreDict("gemFlawedRuby", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 1, 0));
		Util.registerAltarUpgradeOreDict("gemFlawedSapphire", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 1, 0));
		Util.registerAltarUpgradeOreDict("gemFlawedTopaz", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 1, 0));
		Util.registerAltarUpgradeOreDict("gemFlawedTourmaline", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 1, 0));
		Util.registerAltarUpgradeOreDict("gemFlawlessAgate", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 2, 0));
		Util.registerAltarUpgradeOreDict("gemFlawlessAmethyst", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 2, 0));
		Util.registerAltarUpgradeOreDict("gemFlawlessBeryl", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 2, 0));
		Util.registerAltarUpgradeOreDict("gemFlawlessDiamond", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 2, 0));
		Util.registerAltarUpgradeOreDict("gemFlawlessEmerald", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 2, 0));
		Util.registerAltarUpgradeOreDict("gemFlawlessGarnet", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 2, 0));
		Util.registerAltarUpgradeOreDict("gemFlawlessJade", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 2, 0));
		Util.registerAltarUpgradeOreDict("gemFlawlessJasper", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 2, 0));
		Util.registerAltarUpgradeOreDict("gemFlawlessOpal", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 2, 0));
		Util.registerAltarUpgradeOreDict("gemFlawlessRuby", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 2, 0));
		Util.registerAltarUpgradeOreDict("gemFlawlessSapphire", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 2, 0));
		Util.registerAltarUpgradeOreDict("gemFlawlessTopaz", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 2, 0));
		Util.registerAltarUpgradeOreDict("gemFlawlessTourmaline", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 2, 0));
		Util.registerAltarUpgradeOreDict("gemExquisiteAgate", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 2, 0));
		Util.registerAltarUpgradeOreDict("gemExquisiteAmethyst", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 3, 0));
		Util.registerAltarUpgradeOreDict("gemExquisiteBeryl", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 3, 0));
		Util.registerAltarUpgradeOreDict("gemExquisiteDiamond", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 3, 0));
		Util.registerAltarUpgradeOreDict("gemExquisiteEmerald", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 3, 0));
		Util.registerAltarUpgradeOreDict("gemExquisiteGarnet", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 3, 0));
		Util.registerAltarUpgradeOreDict("gemExquisiteJade", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 3, 0));
		Util.registerAltarUpgradeOreDict("gemExquisiteJasper", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 3, 0));
		Util.registerAltarUpgradeOreDict("gemExquisiteOpal", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 3, 0));
		Util.registerAltarUpgradeOreDict("gemExquisiteRuby", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 3, 0));
		Util.registerAltarUpgradeOreDict("gemExquisiteSapphire", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 3, 0));
		Util.registerAltarUpgradeOreDict("gemExquisiteTopaz", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 3, 0));
		Util.registerAltarUpgradeOreDict("gemExquisiteTourmaline", new AltarUpgrade(AltarUpgrade.Type.PENTACLE, 3, 0));
	...
	protected static void addCauldronRecipes() {
		cauldronRecipes.add(new CauldronRecipe(new ResourceLocation(Bewitchment.MODID, "focal_chalk"), Arrays.asList(Util.get(ModObjects.ritual_chalk), Util.get(ModObjects.liquid_witchcraft), Util.get("oreGoldSmall")), Arrays.asList(new ItemStack(ModObjects.focal_chalk), new ItemStack(ModObjects.empty_jar))));
		...
		cauldronRecipes.add(new CauldronRecipe(new ResourceLocation(Bewitchment.MODID, "iron_gall_ink"), Arrays.asList(Util.get(ModObjects.oak_apple_gall), Util.get(ModObjects.oak_apple_gall), Util.get("oreWroughtIronSmall")), Collections.singletonList(new ItemStack(ModObjects.iron_gall_ink, 3))));
		...
		cauldronRecipes.add(new CauldronRecipe(new ResourceLocation(Bewitchment.MODID, "soop_1"), Arrays.asList(Util.get(Items.BEETROOT), Util.get(Items.BEETROOT), Util.get(Items.BEETROOT), Util.get("dustSalt"), Util.get(Items.BOWL)), Collections.singletonList(new ItemStack(Items.BEETROOT_SOUP))));
		cauldronRecipes.add(new CauldronRecipe(new ResourceLocation(Bewitchment.MODID, "soop_2"), Arrays.asList(Util.get(Blocks.BROWN_MUSHROOM), Util.get(Blocks.RED_MUSHROOM), Util.get("dustSalt"), Util.get(Items.BOWL)), Collections.singletonList(new ItemStack(Items.MUSHROOM_STEW))));
	...
	protected static void addDistilleryRecipes() {
		...
		distilleryRecipes.add(new DistilleryRecipe(new ResourceLocation(Bewitchment.MODID, "cleansing_balm"), Arrays.asList(Util.get(ModObjects.acacia_resin), Util.get("cropWhiteSage"), Util.get("dustSalt"), Util.get("cropGarlic")), Arrays.asList(new ItemStack(ModObjects.cleansing_balm), new ItemStack(ModObjects.wood_ash))));
		...
		distilleryRecipes.add(new DistilleryRecipe(new ResourceLocation(Bewitchment.MODID, "oil_of_vitriol"), Arrays.asList(Util.get(ModObjects.cloudy_oil), Util.get("oreWroughtIronSmall"), Util.get("gunpowder"), Util.get(ModObjects.dragons_blood_resin)), Collections.singletonList(new ItemStack(ModObjects.oil_of_vitriol))));
		...
		distilleryRecipes.add(new DistilleryRecipe(new ResourceLocation(Bewitchment.MODID, "stone_ichor"), Arrays.asList(Util.get(ModObjects.cloudy_oil), Util.get("stone"), Util.get("oreWroughtIronSmall"), Util.get("gravel")), Collections.singletonList(new ItemStack(ModObjects.stone_ichor))));
	...
	protected static void addSpinningWheelRecipes() {
		...
		spinningWheelRecipes.add(new SpinningWheelRecipe(new ResourceLocation(Bewitchment.MODID, "golden_thread"), Arrays.asList(Util.get("oreGoldSmall"), Util.get("straw"), Util.get("straw"), Util.get(ModObjects.liquid_witchcraft)), Arrays.asList(new ItemStack(ModObjects.golden_thread, 2), new ItemStack(ModObjects.empty_jar))));
	...
	protected static void addRitualRecipe() {
		...
		ritualRecipes.add(new Ritual(new ResourceLocation(Bewitchment.MODID, "purifying_earth"), Arrays.asList(Util.get("dirt"), Util.get("dirt"), Util.get("dirt"), Util.get("dirt"), Util.get("cropWhiteSage"), Util.get("cropWhiteSage"), Util.get("dustSalt"), Util.get("dustSalt")), null, Collections.singletonList(new ItemStack(ModObjects.purifying_earth, 16)), 2, 200, 20, BlockGlyph.NORMAL, BlockGlyph.NORMAL, -1));
